 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
        ...
        $aksi = "modul/unit_kerja/aksi_unitkerja.php";
        switch ($_GET['aksi']) {
            default:
                echo "
                ...
                <div id='content'>
                    <div class='outer'>
                        ...
                        <p align='left'><a href='?hal=unit-kerja&aksi=tambah' role='button' class='btn btn-primary'>Input Baru</a>
...
<div class='row'>
        ...
        <div class='box'>
            ...
            <div id='collapse4' class='body'>
                <table id='dataTable' class='table table-bordered table-condensed table-hover table-striped'>
                    ...
                    <tbody>";
                $tp = mysqli_query($konek, 'SELECT * FROM unit_kerja ORDER BY id_unitKerja ASC');
                    ...
                    echo "
                            <tr>
                                <td>$no</td>
                                    ...
                                    "; ?>
                  <?php echo "
                               <td align='center'><a data-toggle='tooltip' data-original-title='Edit' class='glyphicon glyphicon-pencil btn btn-default' href='?hal=unit-kerja&aksi=edit&id=$r[id_unitKerja]'></a>
                               "; ?>

                  <a onclick="return confirm('Hapus Data?')" <?php echo " class='btn btn-danger' data-toggle='tooltip' data-original-title='Hapus' href='modul/unit_kerja/aksi_unitkerja.php?act=hapus&id=$r[id_unitKerja]'>"; ?> <i class="glyphicon glyphicon-trash icon-white"></i>
                  </a>
  ...
  <?php echo "
      ...
      ";
            ...
            case "edit":
                $edit = mysqli_query($konek, "SELECT * FROM unit_kerja WHERE id_unitKerja='$_GET[id]'");
...
<div class='col-lg-12'>
    <div class='box dark'>
        <header>
            ...
            <h5>Edit Data Akun Unit Kerja</h5>
            <div class='toolbar'>
        ...
        <div id='div-1' class='body'>
            <form data-validate='parsley' class='form-horizontal' method='post' action='modul/unit_kerja/aksi_unitkerja.php?act=update' enctype='multipart/form-data' >";
                echo "


                  <input type=hidden name=id value=$r[id_unitKerja]>
                <div class='form-group'>
                    <label for='text1' class='control-label col-lg-4'>Nama Lengkap</label>

                    <div class='col-lg-6'>
                        <input required='required' type='text' name='nama' value='$r[nama]' id='text1' placeholder='Nama' class='form-control'>
                    </div>
                </div>
...
<div class='col-lg-12'>
    <div class='box dark'>
        <header>
            <div class='icons'><i class='fa fa-edit'></i></div>
            <h5>Input Data Akun Unit Kerja</h5>
        ...
        <div id='div-1' class='body'>
            <form data-validate='parsley' class='form-horizontal' method='post' action='modul/unit_kerja/aksi_unitkerja.php?act=input' enctype='multipart/form-data' >

                <div class='form-group'>
                    <label for='text1' class='control-label col-lg-4'>Nama Lengkap</label>

                    <div class='col-lg-6'>
                        <input required='required' type='text' name='nama' id='text1' placeholder='Nama' class='form-control'>
                    </div>
                </div>
                ...
                $id_jabatan = '2';
                $id_jabatan2 = '1';
                $tampil = mysqli_query($konek, "SELECT nama_jabatan FROM jabatan WHERE id_jabatan!='$id_jabatan' and id_jabatan!='$id_jabatan2'");
                while (list($nama_jabatan) = mysqli_fetch_row($tampil)) {
                    echo "$<option value=$id_jabatan>$nama_jabatan</option>";
                }
