...
$tempat_penerima = $r['tempat_penerima'];
...
<body><pre>' .
    ...
    '<p align="right"><font face="times new roman" > ' . $kota . ', ' . $format .
    '</p>' .
    '<br><font face="times new roman">Nomor Surat&emsp;&emsp;&emsp;:	' . $nomor .
    ...
    '<td >' .
    '<td>' .
    '<p ><font face="times new roman" >' .  $jabatan_ttd .
    '<br>Politeknik Negeri Indramayu,</p>' .
    '<br><br><br>' .
