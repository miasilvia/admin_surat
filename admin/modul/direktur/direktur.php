 ...
 <center>Untuk mengakses modul, Anda harus login <br>";
        ...
        $aksi = "modul/direktur/aksi_direktur.php";
        switch ($_GET['aksi']) {
            default:
                echo "
                <div id='content'>
                    <div class='outer'>
                        ...
                        <p align='left'><a href='?hal=direktur&aksi=tambah' role='button' class='btn btn-primary'>Input Baru</a> 
    <div class='row'>
      <div class='col-lg-12'>
            <div class='box'>
                <header>
                    <div class='icons'><i class='fa fa-table'></i></div>
                <h5>Data Akun Direktur</h5>
            </header>
            <div id='collapse4' class='body'>
                <table id='dataTable' class='table table-bordered table-condensed table-hover table-striped'>
                    ...
                    <tbody>";
                $tp = mysqli_query($konek, 'SELECT * FROM direktur ORDER BY id_direktur ASC');
                    ...
                    echo "
                            <tr>
                                <td>$no</td>
                                    ...
                                    "; ?>
                  <?php echo "
                               <td align='center'><a class='glyphicon glyphicon-pencil btn btn-default' href='?hal=direktur&aksi=edit&id=$r[id_direktur]'></a>
                               "; ?>

                  <a onclick="return confirm('Hapus Data?')" <?php echo " class='btn btn-danger' href='modul/direktur/aksi_direktur.php?act=hapus&id=$r[id_direktur]'>"; ?> <i class="glyphicon glyphicon-trash icon-white"></i>
                  </a>
  ...
  <?php echo "
      ...
      ";
            ...
            case "edit":
                $edit = mysqli_query($konek, "SELECT * FROM direktur WHERE id_direktur='$_GET[id]'");
...
<div class='col-lg-12'>
    <div class='box dark'>
        <header>
            ...
            <h5>Input Data Akun Direktur</h5>
            <div class='toolbar'>
        ...
        <div id='div-1' class='body'>
            <form data-validate='parsley' class='form-horizontal' method='post' action='modul/direktur/aksi_direktur.php?act=update' enctype='multipart/form-data' >";
                echo "


                  <input type=hidden name=id value=$r[id_direktur]>
...
<div class='col-lg-12'>
    <div class='box dark'>
        ...
        <div id='div-1' class='body'>
            <form data-validate='parsley' class='form-horizontal' method='post' action='modul/direktur/aksi_direktur.php?act=input' enctype='multipart/form-data' >
                ...
                <option value=''></option>";
                $id_jabatan = '2';
                $tampil = mysqli_query($konek, "SELECT nama_jabatan FROM jabatan WHERE id_jabatan!='$id_jabatan'");
