...
<div class='col-lg-12'>
    <div class='box dark'>
        ...
        <div id='div-1' class='body'>
            <form data-validate='parsley' class='form-horizontal' method='post' action='modul/laporan_suratmasuk/cetakpdf.php' enctype='multipart/form-data' target='_blank' >
                ...
                <div class='form-group'>
                  ...
                  <div class='form-actions no-margin-bottom'>
                        <input type='submit' value='Cetak Agenda Surat Masuk' name='cetak2' class='btn btn-primary'>
                  
                        <input type='submit' value='Cetak Arsip Surat Masuk' name='cetak3' class='btn btn-primary'>
                         <input type='submit' value='Cetak Arsip Disposisi Surat Masuk' name='cetak4' class='btn btn-primary'>
                    </div>
