...
<?php $q=mysql_query("select * from admin where username='".$_SESSION['username']."'");
...
echo " <div id='content'>
                    <div class='outer'>
                        ...
                        <p align='right'></p><a href='?unit=minta-surat&aksi=tambah' role='button' class='btn btn-primary'>Input Baru</a>                       
  <div class='row'>
    <div class='col-lg-12'>
          <div class='box'>
              <header>
              ...
              <tbody>";
                    ...
                    $tp=mysql_query("SELECT * FROM permintaan per JOIN admin adm ON per.id_admin=adm.id_admin where adm.id_admin= '".$_SESSION[id_login]."' ORDER BY per.id_permintaan  ASC");
                    while($r=mysql_fetch_array($tp)){$no++;   
                      $perihal=mysql_query("SELECT * FROM kode_perihal WHERE id_perihal='$r[id_perihal]'");
                        $p2=mysql_fetch_array($perihal);  
                    ...
                    echo"
                            <tr>
                               ...
                               <?php echo " <a href='#edit_modal2' class='glyphicon glyphicon-eye-open btn btn-default' data-toggle='modal' data-id=".$r['id_permintaan']."> </a>";
?>

                               
                        
                                <a data-toggle='tooltip' data-original-title='Hapus' onclick="return confirm('Hapus Data?')"  <?php echo " class='btn btn-danger' href='modul/minta_surat/aksi_mintasurat.php?act=hapus&id=$r[id_permintaan]'>";?>
...
case"edit":
$edit = mysql_query("SELECT * FROM buat_suratdinas WHERE id_buatsurat='$_GET[id]' ");
            ...
            <input required='required' type='text' name='nomor_surat' value='$r[nomor_surat]'  class='form-control'>
             ...
             <label class='control-label col-lg-4' for='dpYears'>Tanggal Surat</label>
                        ...
                        <div class='col-lg-3'>
                                ...
                                <input name='tgl_surat' class='form-control' type='date' value='$tgl_minta' >
...
<div class='form-group'   >
             <label class='control-label col-lg-4' for='dpYears'>Tanggal Surat</label>
               ...
               <label class='control-label col-lg-4'>Kode Perihal</label>
                ...
                <option value=''></option>";
                 $tampil=mysql_query('SELECT * FROM kode_perihal order BY nama_perihal');
                            if ($r[id_perihal]==0){
...
case"done":
$input = mysql_query("SELECT * FROM nomor_surat  WHERE id_nomor='$_GET[id]' ");
...
<div class='form-group'>
             ...
             <label class='control-label col-lg-4' for='dpYears'>Tanggal Minta</label>
                        ...
                        <div class='col-lg-3'>
                                ...
                                <input name='tgl_minta' class='form-control' type='date' value='$tgl_minta' >
 ...
 <div class='form-group'>
                ...
                <option value=''></option>";
                $tampil=mysql_query('SELECT * FROM unit_pengelola order BY unit_pengelola');
